...
public class Point implements Comparable<Point> {
    ...
    private class SlopeComparator implements Comparator<Point> {
      ...
      public int compare(Point p1, Point p2) {
        ...
        if (origin.slopeTo(p1) - origin.slopeTo(p2) > 0) return 1;
        else if (origin.slopeTo(p1) == origin.slopeTo(p2)) return 0;
        else return -1;
      }
    }
    ...
    public static void main(String[] args) {
        ...
        Comparator<Point> pointsComparator = points[0].slopeOrder();
        Arrays.sort(points, pointsComparator);
        for (Point p: points) {
          System.out.println(p.toString());
          System.out.println(points[0].slopeTo(p));
        }
        // p1.draw();
    }
}
